        ...
        >
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                >
                    ...
                    <nav v-if="canLogin" class="-mx-3 flex flex-1 justify-end" aria-label="User navigation">
                        <Link
                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        ...
                        >
                            ...
                            <div id="docs-card-content" class="pt-3 sm:pt-5">
                                <h2
                                    class="text-xl font-semibold text-black dark:text-white"
                                >
                                    Vibrant Ecosystem
                        ...
                        <div
                            ...
                            class="relative col-span-2 hidden lg:block"
                        >
